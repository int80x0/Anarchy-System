...
public class HomesManagerCracked {

    private final AnarchySystem plugin;
    private final File homesFile;
    private final Gson gson;
    private Map<String, Map<Integer, HomeData>> playerHomes;

    public HomesManagerCracked(AnarchySystem plugin) {
        this.plugin = plugin;
    ...
    public boolean setHome(Player player, int homeNumber, Location location) {
        ...
        playerHomes.get(playerName).put(homeNumber, new HomeData(location));
        saveHomes();
        return true;
    }
    ...
    public Location getHome(Player player, int homeNumber) {
        String playerName = player.getName().toLowerCase();
        Map<Integer, HomeData> homes = playerHomes.get(playerName);
    ...
    public Map<Integer, HomeData> getPlayerHomes(Player player) {
        return playerHomes.getOrDefault(player.getName().toLowerCase(), new HashMap<>());
    }
